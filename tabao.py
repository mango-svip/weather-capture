...
class LoginTaoBao:
    ...
    async def main(self, username_, pwd_):
        ...
        time.sleep(5)
        await self.page.goto('https://cart.taobao.com/cart.htm')
        time.sleep(5)
        try:
         await self.page.evaluate("$('#J_CheckShop_s_2964008329_1').click()")
        except Exception as e:
            print("exception", e)
        
        # await self.page.click('#J_CheckShop_s_'+shopId+'_1')
        # await self.page.click('#J_Go')
